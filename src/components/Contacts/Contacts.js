...
" target="_blank">
      ...
      <ul className='contacts__list'>
        <li className='contacts__point'>
          ...
          <p className='contacts__pointText'>г. Северодвинск, улица Лесная, 25</p>
        ...
        <li className='contacts__point'>
          ...
          <p className='contacts__pointText'>+7 (818) 450-00-01 , +7 (818) 456-55-16</p>
