    ...
    <section className="managers">
      <ul className="managers__list">
        <li className="manager">
          ...
          <p className="manager__post">Начальник МКУ "АСС Северодвинска</p>
        </li>
        <li className="manager">
        ...
        <li className="manager">
          ...
          <p className="manager__post">Начальник курсов ГО, защиты от ЧС и пожарной безопасности Северодвинска</p>
        </li>
      </ul>
