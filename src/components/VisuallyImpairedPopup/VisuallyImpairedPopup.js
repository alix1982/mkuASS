...
function VisuallyImpairedPopup (props) {
  return (
    <section className={"popupVisuallyImpaire " + (props.isVisuallyImpairedPopup ? ('popupVisuallyImpaire_opened') : '')} aria-label="попап для слабовидящих">
      <ul className="popupvisuallyImpaire__list">
        ...
        <h3 className="popupvisuallyImpaire__pointHeading">
          ...
          <span className="popupvisuallyImpaire__pointHeadingSpan">
            <img src={icon_vopros} className="popupvisuallyImpaire__pointHeadingImg"/>
          </span>
        </h3>
        ...
        <li className="popupvisuallyImpaire__point">
          <button className="popupvisuallyImpaire__close" type="button" onClick = {props.closeVisuallyImpairedPopup}>
