...
function TeachingStaff (props) {
  ...
  return (
    <section className="education">
      <Link to={docSpravka} className="documents__link" target="_blank" rel="noreferrer">
        <img className="documents__icon" src={icon_doc_1} alt="документ"/>
        <p className="documents__text">Справка о кадровом обеспечении образовательного процесса</p>
      </Link>
    </section>
  )
}
