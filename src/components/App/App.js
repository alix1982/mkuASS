  ...
  return (
    <CurrentUserContext.Provider value={currentUser}>
      <Routes >
        <Route path="/" element={
          <>
            <Header openVisuallyImpairedPopup={openVisuallyImpairedPopup} isVisuallyImpairedPopup={isVisuallyImpairedPopup}/>
            <Navigation
        ...
        <Route path="/sampleApplications" element={
          <>
            <Header openVisuallyImpairedPopup={openVisuallyImpairedPopup} isVisuallyImpairedPopup={isVisuallyImpairedPopup}/>
            <Navigation
              isOpenNavigate={isOpenNavigate}
        ...
        <Route path="/basicInformation" element={
          <>
            <Header openVisuallyImpairedPopup={openVisuallyImpairedPopup} isVisuallyImpairedPopup={isVisuallyImpairedPopup}/>
            <Navigation
              isOpenNavigate={isOpenNavigate}
        ...
        <Route path="/structureInformationEducation" element={
          <>
            <Header openVisuallyImpairedPopup={openVisuallyImpairedPopup} isVisuallyImpairedPopup={isVisuallyImpairedPopup}/>
            <Navigation
              isOpenNavigate={isOpenNavigate}
              ...
              onCloseOverlay = {(evt) => onCloseOverlay(evt)}
            />
            <HeaderMain headingText={"Структура и органы управления образовательной организацией"}/>
            <StructureInformationEducation/>
            <Footer/>
          </>
        }/>
        <Route path="/documentsEducation" element={
          <>
            <Header openVisuallyImpairedPopup={openVisuallyImpairedPopup} isVisuallyImpairedPopup={isVisuallyImpairedPopup}/>
            <Navigation
              isOpenNavigate={isOpenNavigate}
        ...
        <Route path="/educationalStandards" element={
          <>
            <Header openVisuallyImpairedPopup={openVisuallyImpairedPopup} isVisuallyImpairedPopup={isVisuallyImpairedPopup}/>
            <Navigation
              isOpenNavigate={isOpenNavigate}
        ...
        <Route path="/teachingStaff" element={
          <>
            <Header openVisuallyImpairedPopup={openVisuallyImpairedPopup} isVisuallyImpairedPopup={isVisuallyImpairedPopup}/>
            <Navigation
              isOpenNavigate={isOpenNavigate}
              ...
              onCloseOverlay = {(evt) => onCloseOverlay(evt)}
            />
            <HeaderMain headingText={"Руководство. Педагогический (научно-педагогический) состав"}/>
            <TeachingStaff/>
            <Footer/>
          </>
        }/>
        <Route path="/materialTechnicalSupport" element={
          <>
            <Header openVisuallyImpairedPopup={openVisuallyImpairedPopup} isVisuallyImpairedPopup={isVisuallyImpairedPopup}/>
            <Navigation
              isOpenNavigate={isOpenNavigate}
              ...
              onCloseOverlay = {(evt) => onCloseOverlay(evt)}
            />
            <HeaderMain headingText={"Материально-техническое обеспечение и оснащенность образовательного процесса"}/>
        ...
        <Route path="/scholarships" element={
          <>
            ...
            <Navigation
              ...
              onCloseOverlay = {(evt) => onCloseOverlay(evt)}
            />
            <HeaderMain headingText={"Стипендии и иные виды материальной поддержки"}/>
            <Scholarships/>
            <Footer/>
          </>
        }/>
        <Route path="/paidEducational" element={
          <>
            <Header openVisuallyImpairedPopup={openVisuallyImpairedPopup} isVisuallyImpairedPopup={isVisuallyImpairedPopup}/>
            <Navigation
              isOpenNavigate={isOpenNavigate}
        ...
        <Route path="/financialActivity" element={
          <>
            <Header openVisuallyImpairedPopup={openVisuallyImpairedPopup} isVisuallyImpairedPopup={isVisuallyImpairedPopup}/>
            <Navigation
              isOpenNavigate={isOpenNavigate}
              ...
              onCloseOverlay = {(evt) => onCloseOverlay(evt)}
            />
            <HeaderMain headingText={"Финансово-хозяйственная деятельность"}/>
            {/* <FinancialActivity/> */}
            <NoPage/>
            <Footer/>
          </>
        }/>
        <Route path="/vacantPlaces" element={
          <>
            <Header openVisuallyImpairedPopup={openVisuallyImpairedPopup} isVisuallyImpairedPopup={isVisuallyImpairedPopup}/>
            <Navigation
              isOpenNavigate={isOpenNavigate}
              ...
              onCloseOverlay = {(evt) => onCloseOverlay(evt)}
            />
            <HeaderMain headingText={"Вакантные места для приема (перевода)"}/>
            {/* <VacantPlaces/> */}
            <NoPage/>
            <Footer/>
          </>
        ...
        <Route path="/photosVideos" element={
          <>
            ...
            <PhotosVideos setSelectedCard={setSelectedCard} openImg={openImg}/>
            <Footer/>
          </>
        }/>
        ...
        <Route path="/questionsAnswers" element={
          <>
            <Header openVisuallyImpairedPopup={openVisuallyImpairedPopup} isVisuallyImpairedPopup={isVisuallyImpairedPopup}/>
            <Navigation
              isOpenNavigate={isOpenNavigate}
