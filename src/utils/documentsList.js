...
const documentsList = [
  {
    titleDoc: "Постановление Администрации МО «Северодвинск» о создании муниципального казенного учреждения «Аварийно-спасательная служба Северодвинска»",
    typeDoc: icon_doc_1,
    path: docPostanovlenie,
    docId: 1,
  },
  {
    titleDoc: "Устав муниципального казенного учреждения «Аварийно-спасательная служба Северодвинска»",
    typeDoc: icon_doc_1,
    path: docYstav,
    docId: 2,
  },
  ...
  {
    titleDoc: "Заключение о соответствии объекта защиты требованиям пожарной безопасности",
    typeDoc: icon_doc_1,
    path: docZaklyuchenie,
    docId: 6,
  },
  {
    titleDoc: "Приказ Председателя Комитета по управлению муниципальным имуществом Администрации МО «Северодвинск» о назначении на должность начальника МУ «АСС Северодвинска»",
    typeDoc: icon_doc_1,
    path: docPrikaz,
    docId: 7,
  },
  {
    titleDoc: "План противодействия коррупции в МКУ «АСС Северодвинска» на 2021-2024 годы",
    typeDoc: icon_doc_1,
    path: docKorupcia,
    docId: 8,
  },
