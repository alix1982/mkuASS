...
import docAkt from './documents/documentsCheck/Akt-proverki-Upravleniya-nadzora-v-sfere-obrazovaniya-Ministerstva-obrazovaniya-i-nauki-Arhangelskoj-oblasti-№-1-k-ot-16.01.2019-g..pdf';
...
const documentsListCheck = [
  ...
  {
    titleDoc: "Предписание №1-л об устранении выявленных нарушений от 16.01.2-19 г",
    typeDoc: icon_doc_1,
    path: docPredpisanieL,
    docId: 2,
  },
  {
    titleDoc: "Предписание №1-н об устранении выявленных нарушений от 16.01.2019 г.",
    typeDoc: icon_doc_1,
